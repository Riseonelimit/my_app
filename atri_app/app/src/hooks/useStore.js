  ...
  "Home": {
    ...
    "Image1": {
      "custom": {
        ...
        "src": "/app-assets/icons8-right-arrow-26.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image2": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/jack-finnigan-rriAI0nhcbc-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image5": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logoipsum-257.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image6": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logoipsum-264.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image7": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logoipsum-255.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Carousel1": {
      "custom": {
        ...
        "startTile": 0,
        "imageItems": [
          "/app-assets/jeff-sheldon-9SyOKYrq-rE-unsplash.jpg",
          "/app-assets/kumpan-electric-kSBWIerVYJs-unsplash.jpg",
          "/app-assets/domenico-loia-hGV2TfOh0ns-unsplash.jpg"
        ],
    ...
    "Image23": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/icons8-right-arrow-64.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image28": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/headway-5QgIuuBxKwM-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image41": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/linkedin-sales-solutions-Mis5fyJi7Q0-unsplash.jpg"
      },
      "callbacks": {
        "onClick": [
          {
